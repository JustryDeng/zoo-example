...
public class TestY3 {
    ...
    @BeforeAll
    static void setUp() {
        System.setProperty("spring.profiles.active", "y3");
    }
    ...
    public void testY3() {
        ...
        headers.add("needDecrypt", "zhi_suo_yi");
        HttpEntity<String> entity = new HttpEntity<>(
                encryptData(XyzReqVO.builder().xyzName(DemoController.randomName()).xyzAge(DemoController.randomAge()).build()),
                headers
        );
    
        ResponseEntity<Object> response = restTemplate.postForEntity("http://localhost:" + port + "/b/y3", entity, Object.class);
