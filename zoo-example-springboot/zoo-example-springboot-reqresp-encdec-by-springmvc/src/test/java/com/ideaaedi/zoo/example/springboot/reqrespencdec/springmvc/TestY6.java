...
public class TestY6 {
    ...
    @BeforeAll
    static void setUp() {
        System.setProperty("spring.profiles.active", "y6");
    }
    ...
    public void testY6() {
        ...
        headers.add("skipDecrypt", "zhi_suo_yi");
        ...
        ResponseEntity<Object> response = restTemplate.postForEntity("http://localhost:" + port + "/b/y6", entity, Object.class);
